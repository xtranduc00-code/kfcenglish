export const p1 = `The extinct thylacine, also known as the Tasmanian tiger, was a marsupial* that bore a superficial resemblance to a dog. Its most distinguishing feature was the dark brown stripes over its back, beginning at the rear of the body and extending onto the tail. The thylacine's average nose-to-tail length for adult males was 162.6 cm, compared to 153.7 cm for females.
...
export const p3 = `Building the Skyline: The Birth and Growth of Manhattan's Skyscrapers
...
Questions 36-40 — The bedrock myth (complete using A–J):
A development plans
B deep excavations
C great distance
D excessive expense
